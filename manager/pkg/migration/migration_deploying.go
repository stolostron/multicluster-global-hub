...
func (m *ClusterMigrationController) deploying(ctx context.Context,
	...
	if migrationv1alpha1.IsMigrationConditionTrue(mcm.Status.Conditions, migrationv1alpha1.ConditionTypeDeployed) ||
	...
	defer m.handleStatusWithRollback(ctx, mcm, &condition, &nextPhase, getTimeout(migrationv1alpha1.PhaseDeploying))
