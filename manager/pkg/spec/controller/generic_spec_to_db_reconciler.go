...
func (r *genericSpecController) processCR(ctx context.Context, request ctrl.Request,
	log logr.Logger,
...
func (r *genericSpecController) processInstanceInTheDatabase(ctx context.Context, instance client.Object,
...
func (r *genericSpecController) deleteFromTheDatabase(ctx context.Context, name, namespace string,
	log logr.Logger,
) error {
