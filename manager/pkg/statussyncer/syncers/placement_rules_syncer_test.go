...
// var _ = Describe("PlacementRulesDbSyncer", Ordered, func() {
// 	const (
// 		leafHubName = "hub1"
// 		testSchema  = database.StatusSchema
// 		testTable   = database.PlacementRulesTableName
// 		messageKey  = constants.PlacementRuleMsgKey
// 	)
...
// 	It("sync the PlacementRule bundle", func() {
// 		By("Create PlacementRule bundle")
