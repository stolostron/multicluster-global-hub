...
// GetClusterConfigValuesFunc is function type that returns the configuration values
// for the given component of given cluster
...
type Renderer interface {
	...
	RenderWithFilter(component, filter string, getConfigValuesFunc GetConfigValuesFunc) (
		[]*unstructured.Unstructured, error)
	RenderForCluster(cluster, component string, getClusterConfigValuesFunc GetClusterConfigValuesFunc) (
		[]*unstructured.Unstructured, error)
	RenderForClusterWithFilter(cluster, component, filter string,
