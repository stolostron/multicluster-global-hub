...
var (
	...
	imageManifests       = map[string]string{
		"hub_of_hubs_agent":       "quay.io/stolostron/multicluster-global-hub-agent:latest",
		"hub_of_hubs_manager":     "quay.io/stolostron/multicluster-global-hub-manager:latest",
		"hub_of_hubs_console_job": "quay.io/stolostron/multicluster-global-hub-operator:latest",
...
func GetImage(annotations map[string]string, componentName string) string {
	if annotations != nil {
		// dev/test only. e.g.
		// use annotation key "hoh-hub_of_hubs_manager-image" to override multicluster-global-hub-manager image
