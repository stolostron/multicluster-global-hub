...
func (k *strimziTransporter) EnsureUser(clusterName string) (string, error) {
	...
	simpleACLs := []kafkav1beta2.KafkaUserSpecAuthorizationAclsElem{
		...
		utils.SetTopicACL(clusterTopic.SpecTopic, []kafkav1beta2.KafkaUserSpecAuthorizationAclsElemOperationsElem{
		...
		utils.SetTopicACL(clusterTopic.StatusTopic, []kafkav1beta2.KafkaUserSpecAuthorizationAclsElemOperationsElem{
			kafkav1beta2.KafkaUserSpecAuthorizationAclsElemOperationsElemWrite,
		}),
	}
