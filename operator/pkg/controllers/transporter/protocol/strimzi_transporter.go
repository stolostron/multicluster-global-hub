...
func isObsoleteManagedHubACL(acl kafkav1beta2.KafkaUserSpecAuthorizationAclsElem, specTopic, migrationTopic string) bool {
	...
	case kafkav1beta2.KafkaUserSpecAuthorizationAclsElemResourceTypeTopic:
		...
		if *acl.Resource.Name == migrationTopic {
			// CVE-2026-71577: strip legacy static Read+Describe on the migration topic.
