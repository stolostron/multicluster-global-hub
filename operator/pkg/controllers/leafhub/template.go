...
func parseHubHypershiftTemplates(manifestFS embed.FS, snapshot, mceSnapshot, acmDefaultImageRegistry, mceDefaultImageRegistry string, acmImages, mceImages map[string]string) (*template.Template, error) {
	tf := template.FuncMap{
