...
DROP TRIGGER IF EXISTS set_timestamp ON local_status.compliance;
CREATE TRIGGER set_timestamp BEFORE UPDATE ON local_status.compliance FOR EACH ROW EXECUTE FUNCTION public.trigger_set_timestamp();
DROP TRIGGER IF EXISTS set_timestamp ON status.aggregated_compliance;
CREATE TRIGGER set_timestamp BEFORE UPDATE ON status.aggregated_compliance FOR EACH ROW EXECUTE FUNCTION public.trigger_set_timestamp();
DROP TRIGGER IF EXISTS set_timestamp ON status.compliance;
CREATE TRIGGER set_timestamp BEFORE UPDATE ON status.compliance FOR EACH ROW EXECUTE FUNCTION public.trigger_set_timestamp();
DROP TRIGGER IF EXISTS set_timestamp ON status.managed_clusters;
CREATE TRIGGER set_timestamp BEFORE UPDATE ON status.managed_clusters FOR EACH ROW EXECUTE FUNCTION public.trigger_set_timestamp();
DROP TRIGGER IF EXISTS set_timestamp ON status.placementdecisions;
CREATE TRIGGER set_timestamp BEFORE UPDATE ON status.placementdecisions FOR EACH ROW EXECUTE FUNCTION public.trigger_set_timestamp();
DROP TRIGGER IF EXISTS set_timestamp ON status.placementrules;
CREATE TRIGGER set_timestamp BEFORE UPDATE ON status.placementrules FOR EACH ROW EXECUTE FUNCTION public.trigger_set_timestamp();
DROP TRIGGER IF EXISTS set_timestamp ON status.placements;
CREATE TRIGGER set_timestamp BEFORE UPDATE ON status.placements FOR EACH ROW EXECUTE FUNCTION public.trigger_set_timestamp();
DROP TRIGGER IF EXISTS set_timestamp ON status.subscription_reports;
CREATE TRIGGER set_timestamp BEFORE UPDATE ON status.subscription_reports FOR EACH ROW EXECUTE FUNCTION public.trigger_set_timestamp();
DROP TRIGGER IF EXISTS set_timestamp ON status.subscription_statuses;
CREATE TRIGGER set_timestamp BEFORE UPDATE ON status.subscription_statuses FOR EACH ROW EXECUTE FUNCTION public.trigger_set_timestamp();
