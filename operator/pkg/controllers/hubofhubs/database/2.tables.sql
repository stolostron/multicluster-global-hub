...
CREATE INDEX local_policies_deleted_at_idx ON status.leaf_hubs (deleted_at);
...
CREATE INDEX status.cluster_deleted_at_idx ON status.managed_clusters (deleted_at);
