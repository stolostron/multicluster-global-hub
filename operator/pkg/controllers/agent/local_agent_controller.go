...
// +kubebuilder:rbac:groups=extensions.hive.openshift.io,resources=imageclusterinstalls;imageclusterinstalls/status,verbs=create;delete;get;list;patch;update;watch
// +kubebuilder:rbac:groups=hive.openshift.io,resources=clusterdeployments;clusterdeployments/status,verbs=create;delete;get;list;patch;update;watch
// +kubebuilder:rbac:groups=metal3.io,resources=baremetalhosts;baremetalhosts/status;hostfirmwaresettings;hostfirmwaresettings/status,verbs=create;delete;get;list;patch;update;watch
