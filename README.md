...
1. clean sync service storage - you can use [edge-sync-service-client](https://github.com/open-horizon/edge-sync-service-client). For reference you can take a look at an example: [sync-service-cleaner](https://github.com/open-cluster-management/hub-of-hubs-sync-service/tree/main/examples).
