...
**Recommendation:** install the above tools on separate VM and run them with "nohup" command (nohup YOUR COMMAND &) to ensure tols are running even when terminal to the VM is diconnected.
