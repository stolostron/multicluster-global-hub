...
hubs. The supported supported setup is to have a ACM Global Hub managing multiple instances of
managed ACM hubs. And each of these managed ACM hubs has one instance of _Central_ running.
...
StackRox _Central_ instance running inside each of the ACM Managed Hubs. Each StackRox _Central_
...
object and the StackRox _Central_ objects.
...
#### Obtain the StackRox API CA certificate
...
#### Create the StackRox API connection details secret
