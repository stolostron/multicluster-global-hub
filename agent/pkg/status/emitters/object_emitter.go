...
type ObjectEmitter struct {
	...
	bundle      *genericbundle.GenericBundle
...
func NewEmitter(
	...
	e := &ObjectEmitter{
		...
		bundle:    genericbundle.NewGenericBundle(),
	}
	// apply the options
	for _, fn := range opts {
		fn(e)
...
func (e *ObjectEmitter) Delete(obj client.Object) error {
	e.mu.Lock()
	defer e.mu.Unlock()
	return e.handleDeltaEvent(obj, e.bundle.AddDelete)
}
...
func (e *ObjectEmitter) Resync(objects []client.Object) error {
	...
	if err := e.bundle.AddResyncMetadata(objects); err != nil {
		return err
	}
	return e.sendBundle()
}
...
func (e *ObjectEmitter) sendBundle() error {
	...
	err := evt.SetData(cloudevents.ApplicationJSON, e.bundle)
	if err != nil {
