...
# install crds
kubectl apply -f ${rootDir}/pkg/testdata/crds/0000_01_operator.open-cluster-management.io_multiclusterhubs.crd.yaml
kubectl apply -f ${currentDir}/components/mch.yaml -n "$namespace"
