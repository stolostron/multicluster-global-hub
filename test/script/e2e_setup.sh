...
helm install standalone-agent "$PROJECT_DIR"/doc/standalone-agent -n open-cluster-management --set image="$MULTICLUSTER_GLOBAL_HUB_AGENT_IMAGE_REF" --kubeconfig "$GH_KUBECONFIG"
