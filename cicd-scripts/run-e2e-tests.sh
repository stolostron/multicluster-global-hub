...
checkEnv "KUBECONFIG" "$KUBECONFIG"
checkEnv "CONTEXT" "$CONTEXT"

checkEnv "IMPORTED1_KUBECONFIG" "$IMPORTED1_KUBECONFIG"
checkEnv "IMPORTED1_CONTEXT" "$IMPORTED1_CONTEXT"
checkEnv "IMPORTED1_LEAF_HUB_NAME" "$IMPORTED1_LEAF_HUB_NAME"
checkEnv "IMPORTED1_NAME" "$IMPORTED1_NAME"

checkEnv "IMPORTED2_KUBECONFIG" "$IMPORTED2_KUBECONFIG"
checkEnv "IMPORTED2_CONTEXT" "$IMPORTED2_CONTEXT"
checkEnv "IMPORTED2_LEAF_HUB_NAME" "$IMPORTED2_LEAF_HUB_NAME"
checkEnv "IMPORTED2_NAME" "$IMPORTED2_NAME"
