...
# hub cluster
hub_kubeconfig="${CONFIG_DIR}/kubeconfig-hub-${HUB_OF_HUB_CTX}"
...
managed1_kubeconfig="${CONFIG_DIR}/kubeconfig-managed1-kind"
...
managed2_kubeconfig="${CONFIG_DIR}/kubeconfig-managed2-kind"
