...
require (
	...
	github.com/authzed/spicedb-operator v1.26.0
...
// Exclude old monolithic cloud.google.com/go module to avoid ambiguous import
exclude cloud.google.com/go v0.81.0
