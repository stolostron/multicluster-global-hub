...
require (
	...
	github.com/cloudevents/sdk-go/protocol/kafka_confluent/v2 v2.0.0-20250219134349-d834326be327
	...
	github.com/project-kessel/inventory-api v0.0.0-20250314135844-3fbaf28021c0
