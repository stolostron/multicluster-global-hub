...
type deltaStateBundleInfo struct {
	bundle   statusbundle.DeltaStateBundle
	metadata *BundleMetadata

	lastDispatchedDeltaBundleData recoverableDeltaStateBundleData
	lastReceivedTransportMetadata bundle.BundleMetadata
	deltaLineHeadBundleVersion    *statusbundle.BundleVersion
}

type recoverableDeltaStateBundleData struct {
	bundle                         statusbundle.DeltaStateBundle
	lowestPendingTransportMetadata bundle.BundleMetadata
}

// getBundle returns the wrapped bundle.
func (bi *deltaStateBundleInfo) getBundle() statusbundle.Bundle {
	return bi.bundle
}
...
func (bi *deltaStateBundleInfo) update(newBundle statusbundle.Bundle, transportMetadata bundle.BundleMetadata,
...
func (bi *deltaStateBundleInfo) updateBundle(newDeltaBundle statusbundle.DeltaStateBundle) error {
...
func (bi *deltaStateBundleInfo) updateMetadata(bundleType string, version *statusbundle.BundleVersion,
	transportMetadata bundle.BundleMetadata, overwriteObject bool,
) {
...
func (bi *deltaStateBundleInfo) getTransportMetadataToCommit() bundle.BundleMetadata {
	if bi.metadata == nil {
		return nil
	}
